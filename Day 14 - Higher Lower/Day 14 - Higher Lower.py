...
print(f"Compare A: {random_a["name"]}, a {random_a["description"]}, from {random_a["country"]}: {random_a["follower_count"]}")
print(f"Compare B: {random_b["name"]}, a {random_b["description"]}, from {random_b["country"]}: {random_b["follower_count"]}")
